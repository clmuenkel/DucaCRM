/**
 * Script to clear email_queue, reset cadences, and create test contact
 * Run with: node scripts/setup-test-data.mjs
 */
...
async function setupTestData() {
  try {
    ...
    console.log('Resetting all active cadences...');
    ...
    if (existing) {
      ...
      if (updateError) {
        ...
        console.log('✓ Updated existing test contact');
      }
    } else {
      // Create new contact
      ...
      if (insertError) {
        ...
        console.log('✓ Created test contact: Carl-Luca Muenkel (18cmuenkel@gmail.com)');
      }
    }

    console.log('\n✅ Setup complete!');
    console.log('  - Email queue cleared');
    console.log('  - Active cadences reset');
    console.log('  - Test contact ready');
  } catch (error) {
