...
export function CallControlsHeader() {
  ...
  // Always show outcome buttons when a contact is loaded in the dialer
  // (works for active cadence, fresh contacts, and all other modes)
  const isInCadence = !!currentContact;
